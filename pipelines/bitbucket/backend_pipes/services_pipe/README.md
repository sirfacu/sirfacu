Para información de como implementar este pipeline remitirse a la documentación en:

https://ubits-dev.atlassian.net/wiki/spaces/IS/pages/3177250817/Services
