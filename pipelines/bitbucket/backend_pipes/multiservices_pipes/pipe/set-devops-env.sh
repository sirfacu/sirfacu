...
export BRANCH_NAME=feature/PC-1346-update-pipeline #Nombre de la rama la entrega bitbucket no cambiar
...
export BITBUCKET_BRANCH=feature/PC-1346-update-pipeline
...
##########################################################################################
export VAR_APM=false
export TD_CPU=1024
export TD_MEMORY=512
export CLUSTER_NAME=ubits-dev-internal-api-ecs
export DOCKER_EXTRA_ARGS=""


##Variables a nivel del repo dependiendo de la cantidad de aplicaicones que hayan dentro de la carpeta APPS
## el nombre va definido por el ultimo string despues de -
## un ejemplo en la carpeta apps todas las aplicaciones se llaman 
# org-chart-NOMBRE_APP_1
# org-chart-NOMBRE_APP_2
# org-chart-NOMBRE_APP_4
# entonces la variable de puerto debe llamarse PORT_APP_1  en MAYUSCULA, el nombre de la carpeta si va en minuscula
#no es obligatorio en mayuscula ya que el pipeline ajsuta y la busca en mayuscula
export PORT_API=5020
export PORT_ASSIGNER=5021

### debe existir en el archivo el package json el siguiente comando:
# npm run build:all
# "build:all": "nest build NOMBRE_APP1 && nest build NOMBRE_APP2 ETC.....",
##